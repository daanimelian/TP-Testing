...
class TestsDemoBlaze:
    ...
    def test_casodepruebaflujodecompras(self):
        ...
        time.sleep(5)
        self.driver.find_element(By.ID, "name").send_keys("lucas")
        time.sleep(5)
        ...
        time.sleep(5)
        self.driver.find_element(By.ID, "card").send_keys("80000000")
        time.sleep(5)
        ...
        time.sleep(5)
        self.driver.find_element(By.ID, "year").send_keys("2027")
        time.sleep(5)
